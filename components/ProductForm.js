    ...
    <>
      ...
      <div className="flex justify-between py-2">
        <button
          type="submit"
          onClick={saveProduct}
          className="flex flex-row items-center text-white bg-success-color hover:bg-success-lighter-color ease-in-out focus:ring-1 focus:outline-none focus:ring-secondary-color font-medium rounded-lg text-sm px-4 py-2.5 text-center cursor-pointer"
        >
          <RiSave3Line />Save
        </button>
        {_id && (
          <button
            ...
            className="flex flex-row items-center text-white bg-danger-color hover:bg-danger-lighter-color ease-in-out focus:ring-1 focus:outline-none focus:ring-secondary-color font-medium rounded-lg text-sm px-4 py-2.5 text-center cursor-pointer"
          >
