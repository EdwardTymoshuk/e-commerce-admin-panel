...
const logout = async () => {
    ...
    return (
        <aside className={(show ? "left-0" : "-left-full") + " items-center bg-primary-color fixed md:static h-auto md:min-h-screen w-full md:max-w-min md:w-auto transition-all"}>
